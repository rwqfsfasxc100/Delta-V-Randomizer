...
const MOD_NAME = "Delta V Randomizer"
const MOD_VERSION_MAJOR = 1
const MOD_VERSION_MINOR = 0
const MOD_VERSION_BUGFIX = 0
const MOD_VERSION_METADATA = ""

# Whether to consider the mod a library, and if the mod should be hidden by default if it is. 
# This should not affect most mods unless you're making a library specifically
...
func loadSettings():
	...
	settings.load_DVRandomizer_FromFile()
	settings.save_DVRandomizer_ToFile()
	modConfig = settings.DVRandomizer
